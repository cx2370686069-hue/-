...
// 仅开发环境暴露的测试接口，免登录创建订单，禁止在生产环境启用
...
router.post('/merchant-confirm-delivery', authMiddleware, roleMiddleware('merchant'), orderController.confirmMerchantSelfDelivery);
